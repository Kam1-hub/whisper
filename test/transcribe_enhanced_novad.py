"""
faster-whisper 降噪音频转录（无VAD版本）
输入: step3_normalized.wav
输出: transcript_enhanced_novad.txt + transcript_enhanced_novad.srt
"""
import os, sys, time
...
txt_path = os.path.join(SCRIPT_DIR, "transcript_enhanced_novad.txt")
srt_path = os.path.join(SCRIPT_DIR, "transcript_enhanced_novad.srt")
